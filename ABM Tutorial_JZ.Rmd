...
Quarantine_Check <- function(df_pop, M_t){
  # Arguments:
  ...
  sus_full_q  <- full_q & M_t == "SQ"
  inf_full_q  <- full_q & M_t == "IQ"
  ...
  exist_quarantine <- df_pop$t_iso  >0 & df_pop$t_iso < t_iso_max
  ...
  M_t[df_pop$v_Ts == t_detect  & M_t =="I" ] <- "IQ"
  M_t[df_pop$v_Ts == t_detect  & M_t =="IQ" ] <- "IQ"
