...
# detect period
detect_time                 <- 9 # time from receiving virus to be detected, 5 days after being infectious

# days to recover from being infected
recover_days                <- 14
...
p_TransmitCommunity   <- 0.07683164968542 #household aldult
