...
fun_Quarantine_Check <- function(df_X, M_t){
  ...
  # Arguments:
  # df_X: Data frame representing the population at the current time cycle t.
  # M_t: Vector representing the states of individuals at the current cycle t.
...
fun_work_exposure <- function(df_X, M_t) {
  ...
  # Arguments:
  # df_X: Data frame representing the population at the current time cycle t.
  # M_t: States at the current cycle t.
